...
> 最后更新: 2026-08-04 | 当前状态: F14 独立服务端 BRPC burst wrapper 已在188部署，预连接同步burst已完成三轮远端smoke；正在修正客户端active门禁并扩大样本。严格25G历史结果见 `docs/F14_STRICT_25G_PRESSURE_RESULTS_2026-08-02.md`；F15 NPU迁移记录继续保留。
