...
> 最后更新: 2026-08-04 | 当前状态: F14 已实现独立服务端 BRPC burst wrapper 并完成本地静态与 Go race 验证，待 ARM64 镜像构建及 188/189 真实部署；严格25G历史结果见 `docs/F14_STRICT_25G_PRESSURE_RESULTS_2026-08-02.md`；F15 NPU迁移记录继续保留。
