...
> 最后更新: 2026-08-03 | 当前状态: F14 已新增 Health 预连接同步发送模式并完成本地验证，待188/189环境对18101执行1000连接、100KB payload实测；正式Recommend burst p99仍待真实环境采样。严格25G历史结果见 `docs/F14_STRICT_25G_PRESSURE_RESULTS_2026-08-02.md`；F15 NPU迁移记录继续保留。
