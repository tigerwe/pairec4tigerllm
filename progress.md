...
> 最后更新: 2026-08-03 | 当前状态: F14 已将同实例 BRPC burst Wrapper修正为p99测量工具，待188/189环境先做快速smoke，再以每档至少1000个正式Recommend样本测量p99。严格25G历史结果见 `docs/F14_STRICT_25G_PRESSURE_RESULTS_2026-08-02.md`；F15 NPU迁移记录继续保留。
